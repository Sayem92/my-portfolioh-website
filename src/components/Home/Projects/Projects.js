...
const Projects = () => {
 ...
 <section class="">
    <div class="container px-6 py-10 mx-auto">
        <h1 class="text-3xl text-center text-green-500 font-bold capitalize lg:text-4xl ">My Projects
        </h1>
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            <div class="overflow-hidden bg-cover rounded-lg cursor-pointer h-96 group"
                ...
                <div
                    ...
                    <h2 class="mt-4 text-2xl font-semibold text-white capitalize">Resale Phones Selling Page </h2>

                    <a href='https://sell-phones-bd.web.app/'>
                    <p class="mt-2 text-lg tracking-wider text-blue-400 uppercase ">Live Demo</p>
                    </a>

                    <a href='https://github.com/Sayem92/sell-phones-bd-client-side'>
                    <p class="mt-2 text-lg tracking-wider text-blue-400 uppercase ">Github Link</p>
                    </a>
                </div>
            </div>
            ...
            <div class="overflow-hidden bg-cover rounded-lg cursor-pointer h-96 group"
                ...
                <div
                    class="flex flex-col justify-center w-full h-full px-8 py-4 transition-opacity duration-700 opacity-0 backdrop-blur-sm bg-gray-800/60 group-hover:opacity-100">
                    <h2 class="mt-4 text-2xl font-semibold text-white capitalize">Photography Services Page</h2>
            ...
            <div class="overflow-hidden bg-cover rounded-lg cursor-pointer h-96 group"
                ...
                <div
                    class="flex flex-col justify-center w-full h-full px-8 py-4 transition-opacity duration-700 opacity-0 backdrop-blur-sm bg-gray-800/60 group-hover:opacity-100">
                    <h2 class="mt-4 text-2xl font-semibold text-white capitalize">Learning Tutorials Page</h2>
