                    ...
                    <div className="lg:w-1/2 lg:mx-6">
                        ...
                        <div className="mt-6 space-y-8 md:mt-8">
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 truncate w-72 text-gray-200">
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 truncate w-72 text-gray-200">01748-433092</span>
                            </p>
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2  truncate w-72 text-gray-200">sayemmiha123@gmail.com</span>
                            </p>
                        </div>
